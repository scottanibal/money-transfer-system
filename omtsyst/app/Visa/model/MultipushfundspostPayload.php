...
/**
 * MultipushfundspostPayload Class Doc Comment
 *
 * @category    Class
 * @description Request body for creating in multi push funds transfer
 * @package     funds_transfer_api
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MultipushfundspostPayload implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'multipushfundspostPayload';
     ...
     * @param string $fee_program_indicator <b>Note:</b> If present, a valid value is required. Spaces or special characters are not allowed.
     * @return $this
     */
     ...
     * @param int $transaction_identifier The VisaNet transaction identifier. If you have previously sent an AFT, this field must include the VisaNet transaction identifier returned in the AFT response.
     * @return $this
     */
