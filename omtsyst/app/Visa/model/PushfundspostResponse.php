...
/**
 * PushfundspostResponse Class Doc Comment
 *
 * @category    Class
 * @description Push Funds Transfer Response
 * @package     funds_transfer_api
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PushfundspostResponse implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'pushfundspostResponse';
     ...
     * @param string $prepaid_balance Min Inclusive: -999999999.999<br><br>Max Inclusive: 999999999.999<br><br>Note: Applicable only for Top Up Transactions
     * @return $this
     */
     ...
     * @param string $prepaid_balance_currency Refer to <a href=\"/request_response_codes#iso_country_and_currency_codes\">ISO Codes</a>
     * @return $this
     */
    ...
    /**
     * Sets response_code
     * @param string $response_code The source for the response; typically, either the recipient issuer or a Visa system.<br><br>Refer to <a href=\"/request_response_codes#response_code\">response Code</a><br><b>Note: </b>: The VisaNet Response Source for the transaction
     * @return $this
     */
