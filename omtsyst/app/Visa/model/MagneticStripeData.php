...
/**
 * MagneticStripeData Class Doc Comment
 *
 * @category    Class
 * @description
 * @package     funds_transfer_api
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MagneticStripeData implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'magneticStripeData';
    ...
    {
        $this->container['track1_data'] = isset($data['track1_data']) ? $data['track1_data'] : null;
        $this->container['track2_data'] = isset($data['track2_data']) ? $data['track2_data'] : null;
    }
    ...
    /**
     * Sets track1_data
     * @param string $track1_data <b>Conditional (see Note)</b><br><br><b>Note:</b> For a cardPresent scenario, magneticStripeData.track1Data (or magneticStripeData.track2Data) must be included.<br><br><b>Note:</b> These fields are only available in OCT transactions in specific geographies. Please reach out to your Visa representative for details
     * @return $this
     */
    ...
    /**
     * Sets track2_data
     * @param string $track2_data <b>Note:</b> For a CardPresent scenario, MagneticStripeData.track1Data (or MagneticStripeData.track2Data) must be included.
     * @return $this
     */
