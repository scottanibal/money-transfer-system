...
/**
 * ReversefundspostPayload Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ReversefundspostPayload implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'reversefundspostPayload';
     ...
     * @param int $transaction_identifier The VisaNet reference number for the transaction. You must use the transactionIdentifier from the initial AFT in this field.
     * @return $this
     */
     ...
     * @param int $acquirer_country_code Use a 3-digit numeric country code for the country of the BIN under which your Visa Direct solution is registered. This must match the information provided during program enrollment.
     * @return $this
     */
     ...
     * @param int $systems_trace_audit_number A unique value should be used for each API method. however, when passing the Account Funding Transaction Reversal (AFTR) method, this value must match the systemsTraceAuditNumber previously passed with the AFT method for the current transaction.
     * @return $this
     */
     ...
     * @param double $foreign_exchange_fee_transaction When present, this field contains the sender's foreign exchange markup fee (markup above the wholesale or VisaNet exchange rate as assessed by the originator.Values in this field must be in the same currency and format as defined in the amount field(minimum value is 0).
     * @return $this
     */
