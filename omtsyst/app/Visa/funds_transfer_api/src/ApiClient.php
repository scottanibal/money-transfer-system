...
class ApiClient
{
     ...
     */
    public function __construct(\funds_transfer_api\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @return mixed
     * @throws \funds_transfer_api\ApiException on a non 2xx response
     */
    public function callApi($path, $resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\funds_transfer_api\ObjectSerializer::sanitizeForSerialization($postData));
        }
